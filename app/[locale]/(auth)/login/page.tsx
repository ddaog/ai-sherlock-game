...
function LoginContent() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-archive-bg px-4 scanlines font-serif">
            <div className="w-full max-w-md p-10 bg-[#080808]/90 border border-archive-border rounded-sm shadow-[0_0_30px_rgba(0,0,0,1)] relative z-10">
