  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-md border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-900">
        Bundled scenarios from <code>data/stories</code> can be opened here too.
        Saving them creates a database override without touching the bundled files.
      </div>
        ...
        <table className="min-w-full divide-y divide-gray-300 dark:divide-zinc-800 bg-white dark:bg-zinc-900">
          <thead className="bg-gray-50 dark:bg-zinc-800/50 text-gray-900 dark:text-gray-100">
            <tr>
              ...
              <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold">Source</th>
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-zinc-800 text-gray-500 dark:text-gray-400">
            {stories && stories.length > 0 ? (
              ...
              <tr>
                <td colSpan={6} className="py-10 text-center text-sm">
                  No scenarios found.
                </td>
              </tr>
            )}
